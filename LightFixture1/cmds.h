...
X(  CmdSetTime,     "stime", false, CmdArgInt, CmdArgInt,  CmdArgNone )
...
X(  CmdSetLevel,    "slev", true,  CmdArgInt,  CmdArgNone,  CmdArgNone )
X(  CmdSetMode,     "mode", false,  CmdArgInt,  CmdArgInt,  CmdArgNone )
X(  CmdGetEdges,    "edges", false,  CmdArgNone,  CmdArgNone,  CmdArgNone )
